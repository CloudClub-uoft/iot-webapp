...
describe('Register Page', () => {
  ...
  describe('2. Negative Tests', () => {
    it('2a. No friendly name entered.', async () => {
      ...
      // await screen.findByText('Device Successfully Registered!');
      // expect(screen.getByLabelText('toast').innerHTML).toBe("Device Successfully Registered!");
    });
